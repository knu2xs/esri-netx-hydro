...
Preparing and performing trace analysis in ArcGIS using NetX against NHD data.
...
```
    ...
    ├── setup.py           <- Setup script for the library (netx_hydro)
    ...
    │   ├── esri-netx-hydro.aprx <- ArcGIS Pro project.    
    │   └── esri-netx-hydro.tbx  <- ArcGIS Pro toolbox associated with the project.
    ...
    └── src                <- Source code for use in this project.
        └── netx_hydro <- Library containing the bulk of code used in this 
                                                  project. 
```
